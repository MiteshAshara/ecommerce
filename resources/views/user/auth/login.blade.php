    ...
    <div class="row justify-content-center">
      <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
        <div class="card border border-light-subtle rounded-3 shadow-sm mt-5">
          ...
          <div class="col-12">
                  <h5 class="m-0 text-secondary text-center">User Login</h5>
            </div>
            <form class="mt-2" method="POST" action="{{ route('admin.login.post') }}">
              @csrf
              ...
              <div class="row gy-2 overflow-hidden">
                ...
                <div class="col-12">
                  <p class="m-0 text-secondary text-center">Don't have an account? <br> <a href="{{ route('user.register') }}" class="link-dark fw-bold text-decoration-none">Sign up</href=></p>
                </div>
              </div>
            </form>
          </div>
